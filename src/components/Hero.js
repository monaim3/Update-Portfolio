...
export default function Hero() {
  return (
    <main className="lg:-mt-28 min-h-screen overflow-hidden bg-[url('/banner-background-one.jpeg')] bg-cover bg-center hero-pattern relative  z-10">
      <div className="container mx-auto px-4 md:px-8 flex items-center pt-10 md:pt-28 ">
        <div className=" grid md:grid-cols-2 gap-8 items-center relative z-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-lg max-w-xl">
              Creative and detail-oriented developer with expertise in React.js,
              Next.js, and modern UI tools, passionate about building
              responsive, user-focused web applications. Always eager to learn,
              grow, and contribute to impactful digital experiences.
            </p>
            <Link href="#project">
              <Button
                className="primary-color hover:primary-color text-white px-8 py-6 text-lg rounded-full mt-4 cursor-pointer
"
              >
                View Projects
              </Button>
